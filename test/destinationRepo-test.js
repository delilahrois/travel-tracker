...
const DestinationRepository = require('../src/destinationRepo');
...
describe('DestinationRepository', () => {
  ...
  it('should be able to create instances of Destination', () => {
  ...
  it('should hold a list of destinations', () => {
    ...
    expect(destinationRepo.destinationList).to.be.an('array');
  });
