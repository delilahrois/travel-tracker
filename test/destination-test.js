...
describe('Destination', () => {
  ...
  beforeEach(() => {
    ...
    destination1 = new Destination(destinationDetails[0]);
  ...
  it('should have an estimation of lodging costs per day', () => {

    expect(destination1.estimatedLodgingCostPerDay).to.equal(70);
  });

  it('should have an estimation of flight cost per person', () => {

    expect(destination1.estimatedFlightCostPerPerson).to.equal(400);
  });

  it('should have an image of the location', () => {
